...
export  const metadata={
    ...
    description:"This Privacy Policy describes how Referral System collects, uses, and discloses your personal information when you visit and use our website (https://www.ikedo.pro/)."
}
          ...
          <div className="flex container mx-auto  flex-col gap-4 p-8 max-md:p-4  text-white">
            ...
            <div className="container mx-auto py-4">
              ...
              <p className="text-gray-400/80 mb-4">
                This Privacy Policy describes how Referral System collects, uses, and discloses your personal
                information when you visit and use our website (https://refferal.vercel.app/).
              </p>
              <h2 className="text-2xl font-semibold mt-6 mb-4">1. Information We Collect</h2>
              <p className="text-gray-400/80 mb-4">
                <strong>Personal Information:</strong> When you create an account or log in using your Google account,
                we collect your name, email address, and any other information you provide.
              </p>
              <p className="text-gray-400/80 mb-4">
                <strong>Usage Data:</strong> We collect information about how you use our website, including your IP
              ...
              <p className="text-gray-400/80 mb-4">
                ...
                disclosure. However, no internet transmission is completely secure, and we cannot guarantee the security
                of your information.
              </p>
              ...
              <p className="text-gray-400/80 mb-4">
                ...
                processing of your personal information and request data portability. To exercise these rights, please
                contact us at [Your Contact Information].
              </p>
              <h2 className="text-2xl font-semibold mt-6 mb-4">6. Changes to Privacy Policy</h2>
              <p className="text-gray-400/80 mb-4">
                We may update this Privacy Policy from time to time. We will notify you of any changes by posting the
                new Privacy Policy on our website. Your continued use of the website after any changes indicates your
              ...
              <p className="text-gray-400/80 mb-4">
                If you have any questions or concerns about this Privacy Policy, please contact us at <a
                  className={`text-yellow-500`} href="mailto:Ra2228621@gmail.com">Ra2228621@gmail.com</a>.
              </p>
            </div>
          </div>
        </section>
