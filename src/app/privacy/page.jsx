        ...
        <div className="flex container mx-auto  flex-col gap-4 p-8 max-md:p-4  text-white">
          ...
          <div className="container mx-auto py-4">
            ...
            <p className="text-gray-400/80 mb-4">
              This Privacy Policy describes how Referral System collects, uses,
              and discloses your personal information when you visit and use our
              website (https://refferal.vercel.app/).
            </p>
            ...
            <p className="text-gray-400/80 mb-4">
              ...
              or log in using your Google account, we collect your name, email
              address, and any other information you provide.
            </p>
            <p className="text-gray-400/80 mb-4">
              <strong>Usage Data:</strong> We collect information about how you
              use our website, including your IP address, browser type, and the
              pages you visit.
            </p>
            <h2 className="text-2xl font-semibold mt-6 mb-4">
            ...
            <p className="text-gray-400/80 mb-4">
              ...
              personal information and request data portability. To exercise
