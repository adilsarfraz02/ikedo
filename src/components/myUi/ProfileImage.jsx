...
export default function ProfileImageModal({ src, alt, size }) {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className='fixed inset-0 w-full h-full bg-black bg-opacity-80 px-4 flex items-center justify-center z-50'>
          <div className='relative'>
            <Image src={src} alt='Full size' className='h-full w-full' />
            <button
